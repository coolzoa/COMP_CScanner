...
unsigned long long A,n,d, t,h,x, f,o,r,a,l,L,F,i,s,H=1<<18,b=250,D[1<<14],z[W*p],q 

=0x820008202625a0;int main(){Display *j = XOpenDisplay(0);Window u=XCreateSimpleWindow
...
(((q>>20        *n)^~-b)+!b&1023               )/1024.; int y(d,)a[d        ]=a[d+3]
